...
Google 官方：从Android11开始要求声明相应权限。若App的targetSdkVersion>=30，需要在AndroidManifest.xml文件中额外增加以下权限，否则无法有效开启功能

```xml
  <uses-permission android:name="android.permission.QUERY_ALL_PACKAGES" />
```

<font color="#dd0000">注意：</font>若应用提交Google应用市场审核时，由于有QUERY_ALL_PACKAGES权限声明而无法通过审核，可去掉声明QUERY_ALL_PACKAGES，用以下声明代替。
