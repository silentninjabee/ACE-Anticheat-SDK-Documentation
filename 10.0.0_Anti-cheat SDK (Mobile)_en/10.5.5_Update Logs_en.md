**Version:V6.6.5（2023-6-02）**

1. Android has added a trusted environment detection capability, and supports detection of cracked version, virtual machine, flash machine, etc.
2. Support to identify Google simulator environment
3. Android root detection coverage magisk_delta

<font color="#dd0000">Note: currently, the SDK for iOS is on the beta version.</font>

**Version:V6.4.14（2023-4-04）**

1. Enhanced emulator detection capability

Note: currently, the SDK for iOS is on the beta version.

**Version:V6.4.12（2023-3-28）**

1. Support detection of "Chong Chong Assistant Virtual Machine"

Note: currently, the SDK for iOS is on the beta version.

**Version:V6.4.11（2023-3-14）**

1. Fix the failure of crafting features in specific scenarios

Note: currently, the SDK for iOS is on the beta version.

**Version:V6.4.10（2023-2-28）**

1. Override the detection of "Micro clone master multi-opener"
2. Enhance the detection of Android root
3. Override the detection of GG modifiers that bypass security schemes

Note: currently, the SDK for iOS is on the beta version.

**Version:V6.4.7（2023-2-10）**

1. Cover the emulator to start the game and then root the scene.
2. Fix the problem of misjudgment of specific scenes caused by scanning the cache by choosing one of the two.

Note: currently, the SDK for iOS is on the beta version.

**Version:V6.4.6（2023-1-4）**
